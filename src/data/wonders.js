...
export const wonders = [
	{
		...
		icon: piramidaIcon,
		description:
			'Chichen Itza — древний город майя в Мексике, знаменитый пирамидой Кукулькана.'
	},
	{
		id: 'christ_redeemer',
		...
		icon: christIcon,
		description:
			'Статуя Христа-Искупителя в Рио-де-Жанейро — символ Бразилии и христианства.'
	},
	{
		id: 'colosseum',
		name: 'Colosseum',
		...
		icon: colosseumIcon,
		description:
			'Колизей в Риме — крупнейший амфитеатр античного мира, символ Римской империи.'
	},
	{
		id: 'great_wall',
		...
		icon: wallIcon,
		description:
			'Великая Китайская стена — древнее укрепление длиной более 20 000 км.'
	},
	{
		id: 'machu_picchu',
		name: 'Machu Picchu',
		...
		icon: machuIcon,
		description:
			'Мачу-Пикчу — затерянный город инков в Перу, одна из главных загадок Южной Америки.'
	},
	{
		id: 'petra',
		name: 'Petra',
		...
		icon: petraIcon,
		description:
			'Петра — древний город, вырезанный в скалах Иордании, известный своей архитектурой.'
	},
	{
		id: 'taj_mahal',
		name: 'Taj Mahal',
		...
		icon: tajIcon,
		description:
			'Тадж-Махал — мавзолей в Агре (Индия), построенный из белого мрамора в честь любви.'
	}
]
